export default {
    template: `
    <div v-if="ulogovan == true" class="mt-4 text-center">
        <h3>Zelite da se odjavite?</h3>
        <button class="btn btn-danger" v-on:click="odjava()">Odjava</button>
    </div>

    <div class="mt-3" v-if="ulogovan == false">
